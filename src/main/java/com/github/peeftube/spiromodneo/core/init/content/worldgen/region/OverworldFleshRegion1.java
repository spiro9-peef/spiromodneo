...
public class OverworldFleshRegion1 extends Region
{
    public OverworldFleshRegion1(ResourceLocation name, int weight)
    ...
    public void addBiomes(Registry<Biome> reg, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper)
    {
        ...
        new ParameterUtils.ParameterPointListBuilder()
                .temperature(ParameterUtils.Temperature.span(ParameterUtils.Temperature.WARM,
                ...
                .build().forEach(point -> builder.add(point, NeoBiomes.FLESH_CAVERNS));
